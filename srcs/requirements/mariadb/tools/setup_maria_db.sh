...
# usign debian script to install with a here_doc. see this tuto : https://linuxize.com/post/how-to-install-mariadb-on-debian-10/
...
#mysql -uroot launch mysql command line client, using echo and passing it to user with a 
